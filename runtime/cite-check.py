...
# R0 (v0.4.0): regex prefix accepts numeric paper_ids (PMID, etc.).
# Previously required [a-zA-Z] prefix, which silently dropped every
# PubMed citation in biomed corpora. The cite-check script now matches
# the documented Paper.paper_id shape (OpenAlex W…, PubMed PMID, Consensus
# internal id) without a leading-letter constraint.
CITE_RE = re.compile(
